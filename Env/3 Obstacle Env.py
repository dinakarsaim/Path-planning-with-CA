...
class Anish():
  def __init__(self):
    self.xpart = [2,2,2,2,2,2,5,5,5,5,5,5,8,8,8,8,8,8]
    self.ypart = [5,6,7,8,9,10,0,1,2,3,4,5,5,6,7,8,9,10]
...
class Environment(object):
  def __init__(self, initial_position, target_position,X_max, Y_max, num_actions):
    ...
    obstacleobject = Anish()

    self.Obstacle_x = obstacleobject.xpart
    self.Obstacle_y = obstacleobject.ypart
